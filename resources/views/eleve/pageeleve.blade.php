...
<div class="d-flex" style="min-height: 100vh;">
    ...
    <div class="bg-dark text-white p-3" style="width: 250px; position: fixed; top: 80px; left: 0; height: calc(100vh - 80px); z-index: 1000; overflow-y: auto;">
        <h4 class="mb-4 mt-3">Menu Élève</h4>
    ...
    <div class="flex-grow-1" style="margin-left: 250px; width: calc(100% - 250px);">
        <!-- Image d'arrière-plan en haut avec photo d'élève - hauteur augmentée -->
        <div class="position-relative" style="height: 300px; background-image: url('{{ asset('images/student-chemistry.jpg') }}'); background-size: cover; background-position: center;">
            <div class="position-absolute w-100 h-100" style="background: rgba(0,0,0,0.4);"></div>
            <div class="position-absolute top-50 start-50 translate-middle text-center text-white">
                <h1 class="display-4 fw-bold">Bienvenue dans notre Laboratoire Virtuel de Chimie</h1>
                <p class="lead">Apprenez, Explorez et Découvrez la magie de la chimie !</p>
            </div>
        </div>
                            ...
                            <a href="#" class="text-decoration-none" onclick="loadContent('simulation')">
                                <div class="card h-100 shadow-sm border-0" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%);">
                                    <div class="card-body text-center text-white">
                                        ...
                                        <p class="card-text small">Expérimentez avec nos simulations interactives</p>
                                    </div>
                                </div>
                            </a>
                        </div>
                            ...
                            <a href="#" class="text-decoration-none" onclick="loadContent('visualisation')">
                                <div class="card h-100 shadow-sm border-0" style="background: linear-gradient(135deg, #f093fb 0%, #f5576c 100%);">
                                    <div class="card-body text-center text-white">
                                        ...
                                        <p class="card-text small">Découvrez les concepts en 3D</p>
                                    </div>
                                </div>
                            </a>
                        </div>
                            ...
                            <a href="#" class="text-decoration-none" onclick="loadContent('quizz')">
                                <div class="card h-100 shadow-sm border-0" style="background: linear-gradient(135deg, #4facfe 0%, #00f2fe 100%);">
                                    <div class="card-body text-center text-white">
                                        ...
                                        <p class="card-text small">Testez vos connaissances</p>
                                    </div>
                                </div>
                            </a>
                        </div>
...
function loadContent(section) {
    ...
    fetch(`/${section}`)
        ...
        .then(html => {
            ...
            // Gestion dynamique des JS selon la section
            if (section === 'simulation') {
                // Charger Three.js si pas déjà présent
                if (!window.THREE) {
